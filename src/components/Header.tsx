    ...
    <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-b border-border/50">
      <div className="mx-auto max-w-lg flex items-center justify-between h-14 px-4">
        ...
        <div className="flex items-center gap-2">
          <Link href="/report" className="w-9 h-9 rounded-xl bg-surface-hover flex items-center justify-center hover:bg-primary/10 transition-colors">
          ...
          <Link href="/achievements" className="w-9 h-9 rounded-xl bg-surface-hover flex items-center justify-center hover:bg-primary/10 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4.5 h-4.5 text-muted">
